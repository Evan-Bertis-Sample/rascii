...
void InputListener::listen()
{
    ...
    {
        InputListener::_handleButtonDown(key);
    }
    ...
    std::map<std::string, ButtonState> stateMap = InputListener::buttonStates;
    for (std::pair<std::string, ButtonState> pair : stateMap)
    {
        ...
        if (state == BUTTON_DOWN)
        {
            ...
            {
                InputListener::_handleButtonUp(key);
            }
        }
    }
}
...
void InputListener::_handleButtonDown(std::string key)
{
    ...
    PressCallbackMap callbackMap = InputListener::buttonCallbacks;
